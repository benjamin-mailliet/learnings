...
INSERT INTO ressource (id, chemin, titre, seance_id, categorie, format) VALUES(4, 'ressources/seances/ea35b8d6-correction.zip', 'Correction du TP (zip)', 3, 'CORRECTION', 'AUTRE');
INSERT INTO ressource (id, chemin, titre, seance_id, categorie, format) VALUES(3, 'ressources/seances/ea35b8d6-TP2.pptx', 'TP2 : Bootstrap', 3, 'SUPPORT', 'AUTRE');
INSERT INTO ressource (id, chemin, titre, seance_id, categorie, format) VALUES(2, 'ressources/seances/91ca9088-Cours1.zip', 'Cours 1 : HTML / CSS', 1, 'SUPPORT', 'AUTRE');
INSERT INTO ressource (id, chemin, titre, seance_id, categorie, format) VALUES(1, 'ressources/seances/f0465006-tp1.zip', 'TP1 : les animaux laids', 2, 'SUPPORT', 'AUTRE');