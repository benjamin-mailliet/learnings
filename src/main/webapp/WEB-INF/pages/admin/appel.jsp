			...
			<form class="form-horizontal" method="post">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td class="${appel.statut == 'NON_SAISI' || appel.statut == null ? 'active' : ''}">
							<label>
								<input type="radio" name="appel.${appel.eleve.id}" value="NON_SAISI" ${appel.statut == 'NON_SAISI' || appel.statut == null ? 'checked' : ''}/>
								Non saisi
							</label>
						</td>
					</tr>
