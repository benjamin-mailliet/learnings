...
//        when(travailDao.getTravauxUtilisateurParSeance(Mockito.eq(3L), Mockito.eq(1L))).thenReturn(Collections.singletonList(travail1));
//
...
//        assertThat(tpsRenduAccessible.get(0).getTravaux()).containsOnly(travail1);
//
//        verify(seanceDao).listerTPNotesParDateRendu(Mockito.any(Date.class));
//        verify(travailDao).getTravauxUtilisateurParSeance(Mockito.eq(3L), Mockito.eq(1L));
//        verify(travailDao).getTravauxUtilisateurParSeance(Mockito.anyLong(), Mockito.anyLong());
//    }
//
//    @Test
...
//            verify(travailDao, Mockito.never()).getTravauxUtilisateurParSeance(Mockito.anyLong(), Mockito.anyLong());
//        }
//    }
//
//    @Test
